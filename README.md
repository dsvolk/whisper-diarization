...
## Denis Volk's comments
I forked this repo from https://github.com/enriquecatala/whisper-diarization instead of the original https://github.com/MahmoudAshraf97/whisper-diarization because I couldn't to install requirements from the original one: there was some versions' mismatch in the required sub-repos. 

This version uses pinned PiPy versions for most of the dependencies, as compared to the original one, which uses direct GitHub links.
After a few trial and errors, I finally succeeded installing the requirements one by one using single pip commands.
